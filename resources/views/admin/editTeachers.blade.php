                ...
                <div class="input-group">
                    <form method="POST" action="{{ route('teachers.update',$data->id) }}" >
                        <div class="row">
                            ...
                            <div class="mb-3">
                            <label for="group">Subject</label> <br>
                            <input type="text" class="col-6" name="subject" value="{{ $data->subject }}"> <br>
                            </div>
                            <div class="mb-3">
                            <label for="phone">Phone</label> <br>
                            <input type="text" class="col-6" name="phone" value="{{ $data->phone }}"> <br>
                            </div>
                            <div class="mb-3">
                            <label for="phone">Email</label> <br>
                            <input type="text" class="col-6" name="email" value="{{ $data->email }}">
                            </div> 
                            <div class="mb-3">
